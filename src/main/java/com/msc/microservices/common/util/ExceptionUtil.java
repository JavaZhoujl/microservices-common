...
import com.msc.microservices.common.exception.TransactionIllegalStateDaoException;
...
import com.msc.microservices.common.web.Error;
...
public final class ExceptionUtil {
    ...
    public static List<Error> handleAllException(Exception ex) {
        ...
        if (ex instanceof TransactionIllegalStateDaoException) {
            key = ((TransactionIllegalStateDaoException) ex).getKey();
        }
